...
#ifndef H_IOB_AXIS_S_AXI_M_READ_INT_CONF_H
#define H_IOB_AXIS_S_AXI_M_READ_INT_CONF_H
...
#define IOB_AXIS_S_AXI_M_READ_INT_VERSION 0x008100

#endif // H_IOB_AXIS_S_AXI_M_READ_INT_CONF_H
