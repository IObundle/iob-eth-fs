...
#ifndef H_IOB_AXISTREAM_OUT_CSRS_CSRS_H
#define H_IOB_AXISTREAM_OUT_CSRS_CSRS_H

/** @file iob_axistream_out_csrs.h
 *  @brief Function prototypes for the iob_axistream_out core.
 *
 *  This file contains the function prototypes to access the Control and Status
 * Registers (CSRs) for the iob_axistream_out core.
 *
...
#include "iob_axistream_out_csrs_conf.h"
 ...
 */
void iob_axistream_out_csrs_init_baseaddr(uint32_t addr);
...
/**
 * @brief Set nwords value.
 * Set the number of words (with TDATA_W bits) to be written to the FIFO.
 * @param value nwords Value.
 */
...
#endif // H_IOB_AXISTREAM_OUT_CSRS__CSRS_H
